function Get-PropertyFileValue
{
<#
  .Synopsis
    Gets a value of an property
  .DESCRIPTION
    Gets a value of an property for a given property file. Function will retrun null if property isn't found in file or is commented out.
  .EXAMPLE
...
#>
    ...
    $result = $props | Where-Object { $_.property -Like "$Property" -and $_.IsActive -eq $true } | Select-Object Property, value
    if($result){
      Return $result
    }else {
      Write-Verbose "Couldn't find $property in $path"
    }
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUwA/mKPQluaQRZDY1s//G2RxX
# yRSggg4fMIIGsDCCBJigAwIBAgIQCK1AsmDSnEyfXs2pvZOu2TANBgkqhkiG9w0B
...
# DjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBT6vKSyzKzosk5K3kpEhG+g
# gIdQwDANBgkqhkiG9w0BAQEFAASCAgBOPYAnYy28dNqtQbc57PYIbfcca4AGdUEE
# B/HJO/32rmyS8xkf/YDWaZWjkn1baMwVvMZGfXgbI5aOJV6ShVMVlZONNzXME2Es
# EzMWv/sKqdnccc5Am3rXfnbu9J/rl0p3zYp4iB6RkPE+dw5T7YCtX4joa9Z16vDI
# rmI92rfX2NMEMxjEdgK+VoqdUKhTRGNCT2H2o6Gq1i5OXYiT+L94xEUSuDoRwQQQ
# KptTBScCU0BYCp8rBibU1FFa8J+1MtbKTJOC9+3yFvMSQrOHslHJ+19HYglpDHCx
# k2Yleioy7N719fylqKMzxAtGj0NRCK58uIi7fHmHvGABjri7/h8acMNoSdwJ+WGh
# vqQ8PAZQQU2fJJyL2hAkVhubyfgVZI0sZVetFXRb1F8Sl45DJK++Yt9DDrPSiYvt
# O+6GKMxVdvqOpl4Y3Q056SrW+9cZcHF9TdPDH9MhW01MDcK50n56jC7+WDa2+8kX
# JmszhQ5v0tCQmq0tG2I+bCNnwvgpGY1/X2W2obFFfrWcvA15TaSnDpcdR6eOlXyd
# oHbz6e/pBogsxf/RjgYKN2s7cwdbi9t36UIMKxgYT0gRDFICw1pubQKe6tN1zjXu
# 0FCGVq733NezugPx2eoo3Vrb+Cz65zTnPhXAPjIIguacUrbh3aYc5XWj9ciePYxu
# /2N+Xa/jZQ==
